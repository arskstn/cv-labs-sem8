...
# Супер, делаем для всех изображений...
...
# Похоже на правду, но у при сравнении с реальной жизнью станет ясно, что мы не инвертировали ось Y и наша траектория перевернулась. Попробуем реализовать по новой, через центроиды:
